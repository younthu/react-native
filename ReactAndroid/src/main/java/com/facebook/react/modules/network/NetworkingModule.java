...
public final class NetworkingModule extends ReactContextBaseJavaModule {
  ...
  /**
  * To disable http2 support for okhttp3, please put code below in your MainApplication.onCreate()
  ...
  */
  ...
  /* package */ NetworkingModule(
    ...
    // Disable http2, There is a bug(https://github.com/square/okhttp/issues/2506) in OKHttp3 lead to crash while communicating with nginx via HTTP2
